...
class DatabaseService {
  final FirebaseFirestore _firebaseInctance = FirebaseFirestore.instance;
  late final CollectionReference _places;
  late final Reference _storageRef;

  DatabaseService() {
    _places = _firebaseInctance.collection('places');
    _storageRef = FirebaseStorage.instance.ref().child('place_images');
  }

  Future<QuerySnapshot> get loadPlaces async {
    try {
      QuerySnapshot snapshot = await _places.get();
      return snapshot;
    } catch (e) {
